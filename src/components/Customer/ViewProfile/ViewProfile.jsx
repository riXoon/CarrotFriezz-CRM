  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-gray-50">
        <header className="bg-gradient-to-r from-orange-400 to-green-500 h-[250px] sm:h-[350px] relative">
          <img
            src={coverPhoto}
            alt="Cover"
          ...
          <div className="absolute inset-0 flex justify-center items-center">
            <div className="mt-[12rem] md:mt-[15rem] sm:mt-[20rem] bg-orange-500 w-40 sm:w-52 h-40 sm:h-52 rounded-full flex items-center justify-center">
              <img src={avatar2} className="w-[7rem] sm:w-[11rem]" />
            </div>
          </div>
        </header>

        <div className="text-center mt-16 md:mt-14 sm:mt-24">
          <h1 className="text-2xl sm:text-3xl font-bold text-green-800">FirstName LastName</h1>
        </div>
              ...
              likes.map((item, index) => (
                <div key={index} className="p-4 border rounded-lg shadow-sm mb-4 bg-white">
                  <div className="flex items-center justify-between">
                    <h2 className="font-medium text-gray-800 text-sm sm:text-base">{item.name}</h2>
